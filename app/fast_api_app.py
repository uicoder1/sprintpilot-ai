...
try:
    ...
    if isinstance(credentials, AnonymousCredentials):
        raise ValueError("Anonymous credentials detected, falling back to standard logger")
    ...
    class StandardLoggerFallback:
        ...
        def log_struct(self, data: dict, severity: str = "INFO"):
            ...
            self._logger.log(level, str(data))
    logger = StandardLoggerFallback(__name__)
allow_origins = (
...
app.title = "sprintpilot-ai"
app.description = "API for interacting with the Agent sprintpilot-ai"

...
root_agent = Agent(
    ...
    instruction=(
        ...
        "VERBATIM TOOL OUTPUT POLICY:\n"
        "IMPORTANT: When a tool (especially 'execute_business_planning_workflow' or any document generator) "
        "returns a report, document, or content, you MUST print the complete returned text verbatim in your "
        "final chat response. Do NOT summarize, truncate, abbreviate, or omit any parts of the tool output "
        "unless the user explicitly asks for a summary. Present the full contents with all headings, tables, "
        "bullet points, and markdown formatting fully intact so the user receives the complete report directly in the chat.\n\n"
        "PERSISTENT MEMORY:\n"
